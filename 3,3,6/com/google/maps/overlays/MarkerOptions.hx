...
class MarkerOptions 
{
	...
	private function set_tooltip(arg1:String):Void
	{
		this._tooltip = arg1;
		return _tooltip;
	}

	public var draggable(get, set):Dynamic;
	
	private function get_draggable():Dynamic
	{
	...
	{
		this._draggable = cast(arg1, Bool);
		return _draggable;
	}

	public var labelFormat(get, set):String;
	
	private function get_labelFormat():openfl.text.TextFormat
	{
		return this._labelFormat;
	}	
	
	private function set_labelFormat(arg1:openfl.text.TextFormat):Void
	{
		this._labelFormat = arg1;
		return _labelFormat;
	}

	public var radius(get, set):Dynamic;
	
	private function get_radius():Dynamic
	{
		return this._radius;
	}	
	
	private function set_radius(arg1:Dynamic):Void
	{
		this._radius = cast(arg1, Float);
		return _radius;
	}

	public var strokeStyle(get, set):com.google.maps.styles.StrokeStyle;
	...
	private function set_strokeStyle(arg1:com.google.maps.styles.StrokeStyle):Void
	{
		this._strokeStyle = arg1;
		return _strokeStyle;
	}

	public var gravity(get, set):Dynamic;
	
	private function get_gravity():Dynamic
	{
		return this._gravity;
	}
	
	private function set_gravity(arg1:Dynamic):Void
	{
		this._gravity = cast(arg1, Float);
		return;
	}
	...
	{
		this._hasShadow = cast(arg1, Bool);
		return _hasShadow;
	}
	...
	public var iconOffset(null, set):openfl.geom.Point;
	
	private function set_iconOffset(arg1:openfl.geom.Point):Void
	{
		this._iconOffset = arg1 == null ? null : new openfl.geom.Point(arg1.x, arg1.y);
		return;
	}
		
	public var icon(null, set):flash.display.DisplayObject;
			
	private function set_icon(arg1:flash.display.DisplayObject):Void
	{
		this._icon = arg1;
		if (this._icon != null)
		{
	...
	private function set_label(arg1:String):Void
	{
		this._label = arg1;
		if (this._label != null)
		{
	...
	public var iconAlignment(get, set):Dynamic;
	
	private function get_iconAlignment():Dynamic
	{
		return this._iconAlignment;
	}	
		
	private function set_iconAlignment(arg1:Dynamic):Void
	{
	...
	{
		return cast(com.google.maps.wrappers.Wrapper.mergeStyles(com.google.maps.overlays.MarkerOptions, arg1), com.google.maps.overlays.MarkerOptions);
	}
