...
public var size(null, setSize):flash;
 	private function setSize(arg1:openfl.geom.Point):Void
{
	if (arg1 == null)
	{
	this._size = null;
...
public var padding(null, setPadding):flash;
...
public var controlStyle(null, setControlStyle):com;
...
public var navigatorStyle(null, setNavigatorStyle):com;
