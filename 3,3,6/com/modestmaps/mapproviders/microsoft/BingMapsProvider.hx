...
class BingMapsProvider extends AbstractMapProvider implements IMapProvider
{
	...
	public function new(/*type:String=ROAD, hillShading:Bool=true, minZoom:Int=AbstractMapProvider.MIN_ZOOM, maxZoom:Int=AbstractMapProvider.MAX_ZOOM, */apiKey:String)
	{
	...
	{		
		...
		flash.Lib.trace("BingMapsProvider.hx - getZoomString - coord : " + coord);
		var sourceCoord:Coordinate = sourceCoordinate(coord);
		flash.Lib.trace("BingMapsProvider.hx - getZoomString - sourceCoord : " + sourceCoord);
		/*
