...
private function setExtent(mapExtent:Dynamic):Void
{
...
public var extent(getExtent, setExtent):MapExtent;
 	private function getExtent():MapExtent
{
...
private function setCenter(location:Dynamic):Void
{
...
public var zoom(null, setZoom):Int;
 	private function setZoom(zoomLevel:Int):Void
{
	_zoom = zoomLevel;
	mapZoomDirty = true;
	mapExtentDirty = false;
...
private function setProvider(provider:Dynamic):Void
{
...
public var provider(getProvider, setProvider):IMapProvider;
 	private function getProvider():IMapProvider
{
	if (_map)
	{
 ...
 */
[Inspectable(category="Map")]
private function setDraggable(isDraggable:Bool):Void
{
