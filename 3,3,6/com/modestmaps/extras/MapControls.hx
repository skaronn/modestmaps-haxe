...
public static inline var GROUPED:Object = {
...
public static inline var SIDES:Object = {
...
public function new(map:Map, keyboard:Bool=true, fullScreen:Bool=false, buttonPositions:Object=null, buttonClass:Class=null)
{
