...
public function new(thickness:Float=0, color:UInt=0, alpha:Float=1, pixelHinting:Bool=false, scaleMode:String="normal", caps:String=null, joints:String=null, miterLimit:Float=3.0)
{
