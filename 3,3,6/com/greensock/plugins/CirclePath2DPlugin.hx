 ...
 * 	<li><b>startAngle</b> : Float - The position at which the target should begin its rotation (described 
 ...
 * 	<li><b>endAngle</b> : Float - The position at which the target should end its rotation (described in
 ...
 * 	<li><b>autoRotate</b> : Bool - When <code>autoRotate</code> is <code>true</code>, the target will automatically 
 ...
 * 	<li><b>rotationOffset</b> : Float - When <code>autoRotate</code> is <code>true</code>, this value will always 
 ...
 * 	<li><b>useRadians</b> : Bool - If you prefer to define values in radians instead of degrees, set useRadians to true.</li>
 * </ul>
 * 
 * 
 * 
...
override public function setRatio(v:Float):Void {
	...
	px:Float = Math.cos(angle) * radius,
