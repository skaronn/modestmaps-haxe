 ...
 */
public function new(target:DisplayObject=null, x:Float=0, y:Float=0, width:Float=100, height:Float=100, smoothing:Bool=false, autoUpdate:Bool=true, fillColor:UInt=0x00000000, wrap:Bool=false) {
	super();
	if (width < 0 || height < 0) {
