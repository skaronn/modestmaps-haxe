 ...
 */
public function new(duration:Float=0, vars:Object=null) {
	this.vars = vars || {};
...
public function _kill(vars:Object=null, target:Object=null):Bool {
 ...
 * @return self (makes chaining easier)
 **/
public function kill(vars:Object=null, target:Object=null):Dynamic {
	_kill(vars, target);
	return this;
}
 ...
 */
public function eventCallback(type:String, callback:Function=null, params:Array=null):Dynamic {
	if (type == null) {
	return null;
 ...
 **/
public function delay(value:Float=NaN):Dynamic {
	if (!arguments.length) {
	return _delay;
	}
 ...
 * @see #timeScale()
 **/
public function duration(value:Float=NaN):Dynamic {
	if (!arguments.length) {
	_dirty = false;
	return _duration;
	}
 ...
 * @see #timeScale()
 **/
public function totalDuration(value:Float=NaN):Dynamic {
	_dirty = false;
 ...
 * @see #totalTime()
 **/
public function time(value:Float=NaN, suppressEvents:Bool=false):Dynamic {
	if (!arguments.length) {
	return _time;
	}
	if (_dirty) {
 ...
 * @see #pause()
 **/
public function totalTime(time:Float=NaN, suppressEvents:Bool=false, uncapped:Bool=false):Dynamic {
	if (!arguments.length) {
	return _totalTime;
	}
	if (_timeline) {
 ...
 * @see #totalProgress()
 **/
public function progress(value:Float=NaN, suppressEvents:Bool=false):Dynamic {
 ...
 * @see #totalTime()
 **/
public function totalProgress(value:Float=NaN, suppressEvents:Bool=false):Dynamic {
	return (!arguments.length) ? _time / duration() : totalTime(duration() * value, suppressEvents);
}
 ...
 * @return Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.
 **/
public function startTime(value:Float=NaN):Dynamic {
	if (!arguments.length) {
	return _startTime;
	}
	if (value != _startTime) {
 ...
 * @see #duration()
 **/
public function timeScale(value:Float=NaN):Dynamic {
	if (!arguments.length) {
	return _timeScale;
	}
