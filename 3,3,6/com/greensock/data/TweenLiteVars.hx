 ...
 * <ul>
 * 	<li><strong>velocity : Float</strong> - the initial velocity of the object measured in units per time 
 * 				unit (usually seconds, but for tweens where useFrames is true, it would 
 * 				be measured in frames). The default is zero.</li>
 * 	<li><strong>acceleration : Float</strong> [optional] - the amount of acceleration applied to the object, measured
 ...
 * 	<li><strong>friction : Float</strong> [optional] - a value between 0 and 1 where 0 is no friction, 0.08 is a small amount of
...
/** @private **/
public var _isGSVars(get_isGSVars, null):Bool;
