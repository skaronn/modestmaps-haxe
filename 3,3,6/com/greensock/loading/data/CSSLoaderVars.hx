...
public function onCancel(value:Dynamic):CSSLoaderVars {
...
public function onComplete(value:Dynamic):CSSLoaderVars {
...
public function onError(value:Dynamic):CSSLoaderVars {
...
public function onFail(value:Dynamic):CSSLoaderVars {
...
public function onHTTPStatus(value:Dynamic):CSSLoaderVars {
...
public function onIOError(value:Dynamic):CSSLoaderVars {
...
public function onOpen(value:Dynamic):CSSLoaderVars {
...
public function onProgress(value:Dynamic):CSSLoaderVars {
