...
public function onCancel(value:Dynamic):MP3LoaderVars {
...
public function onComplete(value:Dynamic):MP3LoaderVars {
...
public function onError(value:Dynamic):MP3LoaderVars {
...
public function onFail(value:Dynamic):MP3LoaderVars {
...
public function onHTTPStatus(value:Dynamic):MP3LoaderVars {
...
public function onIOError(value:Dynamic):MP3LoaderVars {
...
public function onOpen(value:Dynamic):MP3LoaderVars {
...
public function onProgress(value:Dynamic):MP3LoaderVars {
...
/** Float of times that the mp3 should repeat. To repeat indefinitely, use -1. Default is 0. **/
...
/** @private **/
public var isGSVars(getIsGSVars, null):Bool;
 	private function getIsGSVars():Bool {
	return true;
}
