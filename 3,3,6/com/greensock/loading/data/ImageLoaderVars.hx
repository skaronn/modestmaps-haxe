...
public function onCancel(value:Dynamic):ImageLoaderVars {
...
public function onComplete(value:Dynamic):ImageLoaderVars {
...
public function onError(value:Dynamic):ImageLoaderVars {
...
public function onFail(value:Dynamic):ImageLoaderVars {
...
public function onHTTPStatus(value:Dynamic):ImageLoaderVars {
...
public function onIOError(value:Dynamic):ImageLoaderVars {
...
public function onOpen(value:Dynamic):ImageLoaderVars {
...
public function onProgress(value:Dynamic):ImageLoaderVars {
...
public function onSecurityError(value:Dynamic):ImageLoaderVars {
