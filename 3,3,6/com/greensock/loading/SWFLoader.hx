 ...
 * 	<li><strong> centerRegistration : Bool </strong> - if <code>true</code>, the registration point will be placed in the center of the <code>ContentDisplay</code> Sprite which can be useful if, for example, you want to animate its scale and have it grow/shrink from its center.</li>
...
override private function _dump(scrubLevel:Int=0, newStatus:Int=0, suppressEvents:Bool=false):Void {
	...
	if (_loader.content in _rootLookup) {
		...
		untyped __delete__(_rootLookup[_loader.content];
...
var tween:Map<String, Int> = new tweenLite(mc, 1, {x:100});
</listing>
 * 
...
override private function _initHandler(event:Event):Void {
	...
	if (_stealthMode) {
	_initted = true;
	var awaitingLoad:Bool = _loadOnExitStealth;
	...
	if (className.substr(-13) == "__Preloader__") {
		var rslPreloader:Map<String, Int> = tempContent["__rslPreloader"];
...
/** @private **/
override public var url(null, setUrl):String;
