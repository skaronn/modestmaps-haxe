...
private function _dump(scrubLevel:Int=0, newStatus:Int=0, suppressEvents:Bool=false):Void {
	_content = null;
	var isLoading:Bool = Boolean(_status == LoaderStatus.LOADING);
...
public var paused(getPaused, setPaused):Bool;
 	private function getPaused():Bool {
...
public var status(getStatus, null):Int;
...
public var rootLoader(getRootLoader, null):LoaderMax;
 	private function getRootLoader():LoaderMax {
	return _rootLoader;
}
 ...
 * </ul>
 **/
public var auditedSize(getAuditedSize, null):Bool;
 ...
 **/
public var loadTime(getLoadTime, null):Float;
