...
/** @private **/
private static var _underlineExp:RegExp = /%5f/gi;
...
public var request(getRequest, null):URLRequest;
...
public var httpStatus(getHttpStatus, null):Int;
 ...
 * attempt to load it.
 **/
public var scriptAccessDenied(getScriptAccessDenied, null):Bool;
 	private function getScriptAccessDenied():Bool {
