...
/** @private A place to reference an object that should be private from gc - this is used in VideoLoader in order to protect the NetStream object when the loader is disposed. **/
 ...
 * @see #scaleMode
 **/
public var fitWidth(getFitWidth, setFitWidth):Float;
 	private function getFitWidth():Float {
	return _fitWidth;
}
private function setFitWidth(value:Float):Void {
	_fitWidth = value;
	_update();
}
 ...
 * @see #scaleMode
 **/
public var fitHeight(getFitHeight, setFitHeight):Float;
 	private function getFitHeight():Float {
	return _fitHeight;
}
private function setFitHeight(value:Float):Void {
	_fitHeight = value;
	_update();
}
 ...
 * @see #scaleMode
 **/
public var centerRegistration(getCenterRegistration, setCenterRegistration):Bool;
 	private function getCenterRegistration():Bool {
	return _centerRegistration;
}
private function setCenterRegistration(value:Bool):Void {
 ...
 * @see #scaleMode
 **/
public var crop(getCrop, setCrop):Bool;
 	private function getCrop():Bool {
	return _crop;
}
private function setCrop(value:Bool):Void {
	_crop = value;
	_update();
}
...
public var hAlign(getHAlign, setHAlign):String;
 	private function getHAlign():String {
	return _hAlign;
}
...
public var vAlign(getVAlign, setVAlign):String;
 	private function getVAlign():String {
	return _vAlign;
}
...
private function setBgColor(value:UInt):Void {
	_bgColor = value;
	_update();
}
 ...
 * @see #fitHeight
 **/
public var bgAlpha(getBgAlpha, setBgAlpha):Float;
 	private function getBgAlpha():Float {
	return _bgAlpha;
}
private function setBgAlpha(value:Float):Void {
	_bgAlpha = value;
	_update();
}
...
public var rawContent(getRawContent, setRawContent):Dynamic;
 	private function getRawContent():Dynamic {
	return _rawContent;
}
private function setRawContent(value:Dynamic):Void {
...
public var loader(getLoader, setLoader):LoaderItem;
 	private function getLoader():LoaderItem {
	return _loader;
}
private function setLoader(value:LoaderItem):Void {
	_loader = value;
	if (_loader == null) {
	return;
