 ...
 * 
 * <li><strong>strength</strong> : Float - controls how far from the template ease the points are allowed to wander 
 ...
 * 
 * <li><strong>points</strong> : Float - the number of points to be plotted along the ease, making it jerk more or less
 * 		frequently. (Default: <code>20</code>)</li>
 * 
 * <li><strong>clamp</strong> : Bool - setting <code>clamp</code> to <code>true</code> will prevent points from 
 ...
 * 
 * <li><strong>randomize</strong> : Bool - by default, the placement of points will be randomized (creating the roughness)
 ...
 */
public static function create(strength:Float=1, points:UInt=20, clamp:Bool=false, templateEase:Ease=null, taper:String="none", randomize:Bool=true, name:String=""):Ease {
