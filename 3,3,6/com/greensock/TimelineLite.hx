 ...
 * @see #staggerFromTo()
 */
public function insertMultiple(tweens:Array, timeOrLabel:Dynamic=0, align:String="normal", stagger:Float=0):Dynamic {
 ...
 */
public function appendMultiple(tweens:Array, offsetOrLabel:Dynamic=0, align:String="normal", stagger:Float=0):Dynamic {
...
override public function render(time:Float, suppressEvents:Bool=false, force:Bool=false):Void {
	...
	prevTime:Float = _time, 
	prevStart:Float = _startTime, 
	prevTimeScale:Float = _timeScale, 
	prevPaused:Bool = _paused,
	tween:Animation, isComplete:Bool, next:Animation, callback:String, internalForce:Bool;
	if (time >= totalDur) {
...
override public function totalDuration(value:Float=0):Dynamic {
	...
	if (_dirty) {
		...
		prevStart:Float = Infinity,
		prev:Animation, end:Float;
		while (tween) {
