...
/** @private **/
private static const _DEG2RAD:Float = Math.PI / 180;
 ...
 */
public function lineStyle(thickness:Float=1, color:UInt=0x666666, alpha:Float=1, pixelHinting:Bool=false, scaleMode:String="none", caps:String=null, joints:String=null, miterLimit:Float=3, skipRedraw:Bool=false):Void {
...
/** @inheritDoc **/
override public var rotation(getRotation, setRotation):Float;
 	private function getRotation():Float {
	return super.rotation;
}
override private function setRotation(value:Float):Void {
...
/** @inheritDoc **/
override public var visible(getVisible, setVisible):Bool;
 	private function getVisible():Bool {
	return super.visible;
}
override private function setVisible(value:Bool):Void {
	super.visible = value;
	_redrawLine = true;
	update();
}
 ...
 * @see #progress
 **/
public var rawProgress(getRawProgress, setRawProgress):Float;
 	private function getRawProgress():Float {
	return _rawProgress;
}
private function setRawProgress(value:Float):Void {
	this.progress = value;
}
