...
class FormatNumber {
	public static function decimal(v : Float, culture : Culture, ?decimals : Int) {
		return crunch(v, decimals, culture.percent, culture.number.patternNegative, culture.number.patternPositive, culture, null, null);
	}
	public static function percent(v : Float, culture : Culture, ?decimals : Int) {
	...
	public static function permille(v : Float, culture : Culture, ?decimals : Int) {
	...
	public static function currency(v : Float, culture : Culture, ?symbol : String, ?decimals : Int) {
